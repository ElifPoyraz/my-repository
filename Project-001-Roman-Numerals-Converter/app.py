...
def result():
    if request.method =="POST":
        ...
        return render_template ('result.html',number_decimal=num1,number_roman = input(int(num1)),developer_name="Elif")
    else:
        return render_template("result.html", developer_name="Elif")
